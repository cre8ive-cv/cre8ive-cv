...
| `--theme <name>` | `null` | Theme slug from `src/core/themes` (`classic`, `corpo`, `default`, `modern`, `terminal`). Required unless `--generateAll` is active. Monochromatic themes ignore `--color`. |
